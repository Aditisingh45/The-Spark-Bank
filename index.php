...
<body>
  ...
  <div class="center head mt-0">
    <img src="img/Sparks.png" style="height:200px;width:200px" />
    <h2><b>THE SPARK BANK</b></h2>
  </div>
  <!---3 col start-->
        ...
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="img/bank.png">
            </div>
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            ...
            <br />
            <h5><b>Welcome to THE SPARK BANK !</b></h5>
            <br />
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="img/history.png">
            </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="img/user.png">
            </div>
            <button type="button" onclick="location.href='./php/createuser.php'" style="color:black" class="waves-effect waves-light #ffab00 amber accent-4 btn-large"><b> Create User</b><i class="material-icons right">send</i></button>
          </div>
        </div>
      </div>
    </div>
  ...
  <!--sectio-->
  <footer class="center footer" id="footer">
      <div class="footer-section">
      <i class="social-icon fab fa-twitter"></i>
      <i class="social-icon fab fa-facebook-f"></i>
      <i class="social-icon fab fa-instagram"></i>
      <i class="social-icon fas fa-envelope-square"></i>
    <h6 class="info"><b>2021 © Made by Aditi Singh</b></h6>
